    ...
    return (
        ...
        <div className="max-w-screen-xl mx-auto px-4 py-5">
          <p className="text-sm font-semibold text-center text-zinc-800 dark:text-zinc-400">
            Developed by <strong className="font-black">Francis Cawich</strong> powered by 
            <span className="flex items-center justify-center">
              <SiVercel className="inline-block mr-1" /> Vercel
              <TbBrandNextjs className="inline-block mr-1" /> Next.jsasddddddddddddddddddddddddddddd
            </span> 
          </p>
        </div>
      </footer>
